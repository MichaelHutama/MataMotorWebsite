...
<body class="bg-white min-h-screen text-[#333333] font-didact">
    ...
    <main class="max-w-7xl mx-auto px-6 py-12 md:px-12 md:py-16">
        <div class="grid gap-12 lg:grid-cols-[340px_1fr] items-start">
            ...
            <!--INFO ALAMAT, KONTAK-->
            <div class="space-y-8 flex flex-col items-center lg:items-stretch font-century">
                ...
                <div class="text-center md:text-left space-y-4 max-w-[340px] pt-2">
                    <a href="https://maps.app.goo.gl/ds5ZspX4TuabqkTM8" target="_blank" class="block text-mm-navy hover:text-[#0b2b52] transition-colors font-bold text-base md:text-lg leading-snug">
                        <p>Komplek Mutiara Taman Palem</p>
                        <p>Blok H2 No.6,</p>
                        <p>Cengkareng Timur, Jakarta Barat</p>
                    </a>

                    <div class="space-y-3 pt-2 text-mm-gold font-normal text-sm md:text-base flex flex-col items-center lg:items-start">
                        
                        <a href="tel:02156945311" class="flex items-center gap-4 justify-center lg:justify-start w-full max-w-[220px] hover:opacity-80 transition-opacity">
                            <svg class="w-5 h-5 text-mm-navy" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                            <span class="flex-1 text-left">(021) 56945311</span>
                        </a>
                        
                        <a href="https://wa.me/6281310575396" target="_blank" class="flex items-center gap-4 justify-center lg:justify-start w-full max-w-[220px] hover:opacity-80 transition-opacity">
                        ...
                        <a href="https://instagram.com/mata_motor_palem" target="_blank" class="flex items-center gap-4 justify-center lg:justify-start w-full max-w-[220px] hover:opacity-80 transition-opacity">
            ...
            <!--INFO DESKRIPSI-->
            <section class="space-y-6 text-[#4a4a4a] text-[15px] md:text-base font-normal leading-relaxed tracking-wide pt-2 text-justify font-didact">
                <p>
