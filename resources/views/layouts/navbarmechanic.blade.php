    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 md:h-20 items-center justify-between gap-4">
            ...
            <div class="hidden md:flex flex-1 justify-center space-x-10">
                <a href="{{ route('mechanic-home') }}" class="text-gray-900 hover:text-blue-600 px-3 py-2 text-lg font-medium transition duration-200">
                    To Do
                </a>
                <a href="{{ route('mechanic-history') }}" class="text-gray-900 hover:text-blue-600 px-3 py-2 text-lg font-medium transition duration-200">
                    History
                </a>
                <a href="{{ route('mechanic-products') }}" class="text-gray-900 hover:text-blue-600 px-3 py-2 text-lg font-medium transition duration-200">
                    Product
                </a>
            </div>

            <div class="flex items-center gap-2 md:gap-4">
                <button onclick="showMechanicProfile()" class="text-gray-900 hover:text-blue-600 transition duration-200">
        ...
        <div id="mobile-menu" class="hidden md:hidden pb-4">
            <div class="border-t border-gray-200 pt-3 space-y-1">
                <a href="{{ route('mechanic-home') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-600 transition duration-200">
                    To Do
                </a>
                <a href="{{ route('customer-history') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-600 transition duration-200">
                    History
                </a>
                <a href="{{ route('products') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-600 transition duration-200">
                    Product
                </a>
            </div>
        </div>
