    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 md:h-20 items-center justify-between gap-4">
            ...
            <div class="hidden md:flex flex-1 justify-center space-x-10">
                <a href="{{ route('products') }}" class="text-gray-900 hover:text-blue-600 px-3 py-2 text-lg font-medium transition duration-200">
                    Products
                </a>
            ...
            <div class="flex items-center gap-2 md:gap-4">
                <a href="{{ route('customer-profile') }}" class="text-gray-900 hover:text-blue-600 transition duration-200">
